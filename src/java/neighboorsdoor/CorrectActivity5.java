...
public class CorrectActivity5  extends AppCompatActivity {
    ...
    public void onGoBackButtonClick(View view) {
        clearAttempts();
        Intent intent = new Intent(this, CorrectActivity5.class); // Navigate to CorrectActivity4
