...
public class cutscene_lvl5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cutscene_lvl5);

        Intent intent = getIntent();
        attempts = intent.getIntExtra("attempts", MAX_ATTEMPTS);

        videoView = findViewById(R.id.cutscene5);
        skip = findViewById(R.id.skip);

        videoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mp) {
                Intent i = new Intent(getApplicationContext(), CorrectActivity5.class);
                startActivity(i);
    ...
    private void playscene5() {
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.scene5);
